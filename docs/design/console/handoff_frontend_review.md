...
- 대상: `docs/design/console/handoff_frontend.md` (명세부 v1, 레드팀 미검토)
- 대상 commit: `3078e5d`
- 검토일: 2026-06-30
...
- 대상: `docs/design/console/handoff_frontend.md` (명세부 v2, reviser 보완 `a575fa4`)
- 검토일: 2026-06-30
...
- 대상: `docs/design/console/handoff_frontend.md` (명세부 v3, reviser 보완 `1bb58bb`)
- 검토일: 2026-06-30
