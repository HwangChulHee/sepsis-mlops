...
[`design/`](design/README.md), 서빙·확장 인프라 결정은 [`docs/adr/`](docs/adr/serving-scaling.md).
...
설계 전문은 [`design/console/decisions.md`](design/console/decisions.md).
...
오르내린다. 설계: [`design/replay/`](design/replay/).
...
증거 전문: [`design/replay/round_b_evidence.md`](design/replay/round_b_evidence.md).
