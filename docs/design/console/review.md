...
- **대상**: `docs/design/console/decisions.md` (v1 초안, 설계부)
...
- 대상: docs/design/console/decisions.md (v3, 라운드 3에서 PASS 받음)
- 검토일: 2026-06-29
...
- 대상: docs/design/console/decisions.md (v4)
...
- 대상: `docs/design/console/decisions.md` (v4 + reviser 커밋 `6fe8bd5`)
- 검토일: 2026-06-29
