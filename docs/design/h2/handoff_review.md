...
- **대상**: `design/h2/handoff.md` v2 (개정 이력 v2 — HOLD 3건 + 명칭 정정)
- **검토일**: 2026-06-28
...
- **14행 표 인라인** (`:84-100`): research/03:96-118과 동일, 핸드오프 내부가 기준이라 **research/03 미개봉으로 기계판정 가능**. 자립성 모순(v1의 `참조 금지` vs PASS #3) 소멸.
