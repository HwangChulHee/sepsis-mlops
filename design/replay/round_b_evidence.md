...
PYTHONPATH=src uv run python scripts/replay_patient.py \
  ...
  | tee reports/replay_p000018_septic.txt
...
- `reports/replay_p000018_septic.txt` — septic p 시퀀스(raw 증거, 134줄).
- `reports/replay_p000001_control.txt` — 위양성 control(54줄).
- `reports/replay_p000002_control.txt` — 저위험 control(23줄).
